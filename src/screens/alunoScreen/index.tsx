        ...
        <ScrollView contentContainerStyle={{ backgroundColor: '#081E06' }}>
            <View style={{ flex: 1, width: '100%' }}>
                ...
                <View style={{ flex: 3, padding: 20, }}>
                    ...
                    <View style={{ marginBottom: 10 }}>
                        <View style={{ padding: 10, alignItems: 'center', justifyContent: 'center', backgroundColor: '#0F360A', borderRadius: 20 }}>
                            <Text style={{ fontSize: 20, color: 'white', fontWeight: 'bold', textAlign: 'center' }}>Turmas Matriculadas</Text>
                        </View>
                        ...
                        <View style={{ alignItems: 'center', justifyContent: 'center', marginTop: 20 }}>
                            <DataTable style={{ backgroundColor: 'white', borderRadius: 10 }}>
                                ...
                                <DataTable.Row>
                                    <DataTable.Cell>Disciplina 1</DataTable.Cell>
                                    <DataTable.Cell numeric>0,0</DataTable.Cell>
                                </DataTable.Row>

                                <DataTable.Row>
                                    <DataTable.Cell>Disciplina 2</DataTable.Cell>
                                    <DataTable.Cell numeric>0,0</DataTable.Cell>
                                </DataTable.Row>

                                <DataTable.Row>
                                    <DataTable.Cell>Disciplina 3</DataTable.Cell>
                                    <DataTable.Cell numeric>0,0</DataTable.Cell>
                                </DataTable.Row>
